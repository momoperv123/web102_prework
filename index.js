...
const summaryStr = `A total of $${totalRaised.toLocaleString()} has been raised for ${totalGames} game${totalGames === 1 ? "" : "s"}. 
Currently, ${unfundedGames} game${unfundedGames === 1 ? " remains" : "s remain"} unfunded.`;

// create a new DOM element containing the template string and append it to the description container
const unfundedStrElement = document.createElement('p');
unfundedStrElement.textContent = summaryStr;

descriptionContainer.appendChild(unfundedStrElement);
